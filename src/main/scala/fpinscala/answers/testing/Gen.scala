...
import Gen.*
import Prop.*
import Prop.Result.Falsified
import Prop.Result.Passed
import Prop.Result.Proved
...
object Prop:
  ...
  extension (self: Prop)
    ...
    /* This is rather simplistic - in the event of failure, we simply wrap the
     * failure message with the given message. */
