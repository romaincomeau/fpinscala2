...
import fpinscala.exercises.gettingstarted.PolymorphicFunctions.compose
import fpinscala.exercises.gettingstarted.PolymorphicFunctions.curry
import fpinscala.exercises.gettingstarted.PolymorphicFunctions.isSorted
import fpinscala.exercises.gettingstarted.PolymorphicFunctions.uncurry
